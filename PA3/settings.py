...
SECRET_KEY = 'django-insecure-@gltn#csc=vo@c7oihlbo_b9lfkrg-#a_!xs3+w%c28(e_6k&t'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',  # Isso garante que o Django procure por templates na pasta 'templates'
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
